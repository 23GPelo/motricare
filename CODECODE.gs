...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '1NmegSgfjiYvpI9fN3IkDW_clNy20HQXEsok5q3Pzbuw',     //** CHANGE !!!
    dataRage        : 'patients!A2:G',                                    //** CHANGE !!!
    idRange         : 'patients!A2:A',                                    //** CHANGE !!!
    lastCol         : 'G',                                                //** CHANGE !!!
    insertRange     : 'patients!A1:G1',                                   //** CHANGE !!!
    sheetID         : '588331216',
    sheetName       : 'patients'                                        //** CHANGE !!! 
...
function getRangeByID(id){
  if(id){
    ...
    for(var i = 0; i<idList.length; i++){
      if(id == idList[i][0]){
        return globalVariables().sheetName+'!A'+(i+2)+':'+globalVariables().lastCol+(i+2);
      }
    }
  }
}
